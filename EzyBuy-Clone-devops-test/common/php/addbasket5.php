...
function submitForm(userid,password,storeid,currency,language,productinfo,storeurl)
 {
	...
	var contactAgent = {
		...
		var text="We almost there...<br/>You are being redirected to your shopping cart.";
 ...
 <div id="message" style="font-size:18px;text-align:center;height:50px;vertical-align:middle;"></div>
<?php
