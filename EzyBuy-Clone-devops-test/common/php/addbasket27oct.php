...
else
{
	if($AddBasketURL!="")
	{
		...
		{
		echo '<div style="font-size:18px;text-align:center;height:50px;vertical-align:middle;">We almost there...<br/>You are being redirected to your shopping cart.</div>';
