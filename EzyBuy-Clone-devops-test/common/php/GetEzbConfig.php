...
//echo "Country is ".$cc." and language is".$lc;
$ms = strtolower($ms);
...
//Added by Nithiyanandhan on 06-Sep-2016 - Start
//$queryArray=array("cc"=>$cc,"lc"=>$urlLang,"ms"=>$ms,"clientId"=>$clientId,"format"=>$format,"callback"=> $callback);
$queryArray=array("cc"=>$cc,"lc"=>$urlLang,"ms"=>$ms,"clientId"=>$clientId,"format"=>$format,"callback"=> $callback);
//End
$products="";
